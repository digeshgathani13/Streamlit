...
class StreamlitImages(object):
    ...
    def save(self):
        for name, data in self._data.items():
            #st.write(name)
            Image.open(io.BytesIO(data)).save("C://Digesh Personal//SimpliLearn//Capstone_Project//Streamlit/%s" % name)
...
st.image("C:/Digesh Personal/SimpliLearn/Capstone_Project/Streamlit/image.png", caption="/tmp/image.png", output_format="PNG")

st.header("From open")
st.image(open("C:/Digesh Personal/SimpliLearn/Capstone_Project/Streamlit/image.png", "rb").read(), caption="from read", output_format="PNG")
